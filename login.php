...
-->		      			<a href="index.html"><img id="FitMeInLogoNav" id="logo-container" src="./images/fitmein_logo_final.png" class="brand-logo"></a>
			...
			<div class="container col s6 valign-wrapper" >
			<div class="container ">
		   		<div class="header center textShadow"><h1 style="color: white; text-align: center;">Log In</h1></div>
			</div>
